...
- Store mode on the whole Research Thread.
- Store no Run mode and infer manual behavior only from handoff records.

## Consequences

- One Research Thread or Research Task can contain both manual and automatic Runs, which supports retries and mixed operating styles.
