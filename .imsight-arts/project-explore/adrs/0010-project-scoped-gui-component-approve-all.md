...
- Scope approve-all to one Topic Workspace and selected Agent Team Instance.
- Scope approve-all to the whole Project until revoked.

## Consequences

- Approve-all state belongs to the Project, not to one browser session or one Topic Workspace.
