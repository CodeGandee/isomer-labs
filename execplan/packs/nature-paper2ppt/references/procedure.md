...
### Adapter mechanics (how this pack implements Step 4–5)
...
- **Layout adaptation rule:** do NOT default to a fixed 50/50 split. Choose layout from the figure's aspect
  ...
  annotations; a crop instead of shrinking a dense graphic. Treat 1:1 layouts as the exception. (This pack's
...
Revise obvious defects; document any remaining limitation in **`qa_report.md`**. (This pack's adapter
...
If PPTX tooling is unavailable: this pack's adapter emits a **self-contained HTML deck** at the same `--ref`
