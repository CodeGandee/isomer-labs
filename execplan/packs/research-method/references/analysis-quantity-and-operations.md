...
Use this reference for analysis-campaign sizing targets, the full slice-evidence contract, and
the longer campaign + decision operational tactics.
`analysis-campaign/SKILL.md`, `analysis-campaign/references/operational-guidance.md`, and
`decision/references/operational-guidance.md`.
...
hard gates. These tactics describe the managed harness shell (`bash_exec(...)`):
...
memory card is advisory continuity context. Use `references/checkpoint-memory-template.md`.
