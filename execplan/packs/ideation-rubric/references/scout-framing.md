...
Scout framing craft.
`references/operational-guidance.md`. Use this reference when the quest does not
...
- **Durable-output note.** When scout matters, leave behind just enough durable
  ...
  frame, leave a literature scouting report (prefer the structure in
  `literature-scout-template.md`) rather than letting the survey live only in
  chat.
