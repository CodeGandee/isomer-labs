...
- **THEN** the record carries applicable refs to Research Topic, Research Inquiry, Research Task, Run, Workflow Stage, Agent Team Instance, Agent Instance, or Agent Workspace without defining those lifecycle objects' full state machines
