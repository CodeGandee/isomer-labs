# workbench-browser-history-navigation Specification

## Purpose
TBD - created by archiving change add-workbench-browser-history-navigation. Update Purpose after archive.
## Requirements
