# topic-workspace-visibility-layout Specification

## Purpose
TBD - created by archiving change standardize-topic-workspace-visibility-layout. Update Purpose after archive.
## Requirements
