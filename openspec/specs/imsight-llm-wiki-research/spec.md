...
Define the web-research capability of `imsight-llm-wiki`, which discovers sources for a topic and ingests approved sources through the normal ingest pipeline.
