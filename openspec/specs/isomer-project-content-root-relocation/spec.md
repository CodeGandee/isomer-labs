# isomer-project-content-root-relocation Specification

## Purpose
TBD - created by archiving change add-project-content-root-move-command. Update Purpose after archive.
## Requirements
