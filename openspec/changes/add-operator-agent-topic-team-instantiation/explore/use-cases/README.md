...
- [UC-02: Topic Service Agent Drafts an Instantiation Packet](uc-02-topic-service-agent-drafts-instantiation-packet.md) — a Houmao-backed Topic Service Agent supports Topic Team Specialization for `deepsci-mini`, resolves topic placeholders, and returns a reviewable Topic Team Instantiation Packet.
