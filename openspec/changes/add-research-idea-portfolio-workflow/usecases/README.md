...
| [UC-06](uc-06-browse-kaoju-directions-in-the-idea-portfolio.md) | Browse Kaoju Directions in the Idea Portfolio | Proposed | Can I inspect Kaoju survey directions through the same GUI as other ideas? |

## Notes

- UC-01 through UC-04 and UC-06 are read-only Project Web inspection workflows. They do not change Workspace Runtime or canonical Research Idea state.
...
- UC-06 requires Kaoju to project Direction Set proposal concepts into the canonical Research Idea portfolio; Project Web does not parse Kaoju payloads or require DeepSci to be installed.
