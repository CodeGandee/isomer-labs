"""DeepScientist-compatible mock service over Isomer Workspace Runtime."""
...
from isomer_labs.deepsci_ext.registry import ARTIFACT_TOOLS, MEMORY_TOOLS, split_tool_name
