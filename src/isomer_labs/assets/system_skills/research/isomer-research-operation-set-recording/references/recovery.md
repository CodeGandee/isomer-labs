...
- A missing Research Idea effect requires `$isomer-research-idea-recording` or a new corrective record operation with authored semantics. Do not infer historical facets or Idea Lineage.
