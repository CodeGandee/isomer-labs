...
This compatibility page exists for older references to the previous production DeepSci migration. The operative guidance, preferences, constraints, and quality gates now live in the preserved source-reference runtime pages named above.
