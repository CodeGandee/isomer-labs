...
Use this reference at the start of an `isomer-rsch-idea` pass whenever the real target might differ from the easiest available surrogate. Placeholder definitions live in `../migrate/placeholders.md`.
