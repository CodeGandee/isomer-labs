...
| --- | --- | --- | --- | --- | --- | --- |
| <ANALYSIS_CONTEXT_BRIEF> | evidence | Evidence Item with an Artifact on-demand view when the evidence needs rich content | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/evidence/analysis-context-brief/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --placeholder '<ANALYSIS_CONTEXT_BRIEF>' --format-profile isomer:deepsci/record-format/profile/evidence/analysis-context-brief/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'analysis slices and route decision' --payload-file <payload-file>` |
| <PARENT_RESULT_EVIDENCE> | evidence | Evidence Item with an Artifact on-demand view when the evidence needs rich content | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/evidence/parent-result-evidence/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --placeholder '<PARENT_RESULT_EVIDENCE>' --format-profile isomer:deepsci/record-format/profile/evidence/parent-result-evidence/v2 --skill isomer-deepsci-analysis --producer 'experiment, write, review, decision, or user context' --consumer 'isomer-deepsci-analysis' --payload-file <payload-file>` |
| <ANALYSIS_RESOURCE_ENVELOPE> | runtime state | View Manifest, Workflow Stage Cursor, or control Artifact | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/control/analysis-resource-envelope/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --placeholder '<ANALYSIS_RESOURCE_ENVELOPE>' --format-profile isomer:deepsci/record-format/profile/control/analysis-resource-envelope/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'campaign design and execution' --payload-file <payload-file>` |
| <ANALYSIS_CAMPAIGN_PLAN> | handoff | Handoff packet Artifact, or Handoff Record when dispatching across agents | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/handoff/analysis-campaign-plan/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<ANALYSIS_CAMPAIGN_PLAN>' --format-profile isomer:deepsci/record-format/profile/handoff/analysis-campaign-plan/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'slice execution and downstream decision' --payload-file <payload-file>` |
| <ANALYSIS_CAMPAIGN_CHECKLIST> | runtime state | View Manifest, Workflow Stage Cursor, or control Artifact | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/control/analysis-campaign-checklist/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --placeholder '<ANALYSIS_CAMPAIGN_CHECKLIST>' --format-profile isomer:deepsci/record-format/profile/control/analysis-campaign-checklist/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'campaign validation' --payload-file <payload-file>` |
| <ANALYSIS_SLICE_PLAN> | handoff | Handoff packet Artifact, or Handoff Record when dispatching across agents | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/handoff/analysis-slice-plan/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<ANALYSIS_SLICE_PLAN>' --format-profile isomer:deepsci/record-format/profile/handoff/analysis-slice-plan/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'slice execution' --payload-file <payload-file>` |
| <ANALYSIS_SLICE_RECORD> | evidence | Evidence Item with an Artifact on-demand view when the evidence needs rich content | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/evidence/analysis-slice-record/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --placeholder '<ANALYSIS_SLICE_RECORD>' --format-profile isomer:deepsci/record-format/profile/evidence/analysis-slice-record/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'campaign summary and downstream decision' --payload-file <payload-file>` |
| <ANALYSIS_WRITEBACK_MAP> | handoff | Handoff packet Artifact, or Handoff Record when dispatching across agents | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/handoff/analysis-writeback-map/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<ANALYSIS_WRITEBACK_MAP>' --format-profile isomer:deepsci/record-format/profile/handoff/analysis-writeback-map/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'write, review, rebuttal, decision, finalize' --payload-file <payload-file>` |
| <ANALYSIS_CAMPAIGN_SUMMARY> | report | Artifact with a report profile | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/report/analysis-campaign-summary/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<ANALYSIS_CAMPAIGN_SUMMARY>' --format-profile isomer:deepsci/record-format/profile/report/analysis-campaign-summary/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'decision, finalize, write, experiment, idea' --payload-file <payload-file>` |
| <ANALYSIS_ROUTE_DECISION> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/analysis-route-decision/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --placeholder '<ANALYSIS_ROUTE_DECISION>' --format-profile isomer:deepsci/record-format/profile/decision/analysis-route-decision/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'any production DeepSci research skill' --payload-file <payload-file>` |
| <ANALYSIS_BLOCKER_RECORD> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/analysis-blocker-record/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --placeholder '<ANALYSIS_BLOCKER_RECORD>' --format-profile isomer:deepsci/record-format/profile/decision/analysis-blocker-record/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'user, decision, or continued analysis' --payload-file <payload-file>` |
| <ANALYSIS_CONTINUITY_UPDATE> | runtime state | View Manifest, Workflow Stage Cursor, or control Artifact | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/control/analysis-continuity-update/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --placeholder '<ANALYSIS_CONTINUITY_UPDATE>' --format-profile isomer:deepsci/record-format/profile/control/analysis-continuity-update/v2 --skill isomer-deepsci-analysis --producer 'isomer-deepsci-analysis' --consumer 'future research work' --payload-file <payload-file>` |
