...
1. Discover the selected production DeepSci skill set from the user's requested route, Topic Creator summary, actor onboarding context, Topic Team Profile skill bindings, or operator-provided skill list.
...
| Field | Meaning |
| --- | --- |
| skill | Production DeepSci skill that owns the binding page. |
