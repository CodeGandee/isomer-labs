...
| --- | --- | --- | --- | --- | --- | --- |
| DEEPSCI:FINALIZE-CONTEXT-BRIEF | evidence | Finalize context View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/finalize-context/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --semantic-id 'DEEPSCI:FINALIZE-CONTEXT-BRIEF' --format-profile isomer:deepsci/record-format/profile/paper/finalize-context/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'closure gate' --payload-file <payload-file> --metadata-json '{"paper_surface":"finalize_context"}'` |
| DEEPSCI:CLAIM-LEDGER | report | Claim ledger Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/claim-ledger/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:CLAIM-LEDGER' --format-profile isomer:deepsci/record-format/profile/paper/claim-ledger/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'final summary, writing, archive' --payload-file <payload-file> --metadata-json '{"paper_surface":"claim_ledger"}'` |
| DEEPSCI:FINAL-LIMITATIONS-REPORT | report | Final limitations Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/final-limitations-report/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FINAL-LIMITATIONS-REPORT' --format-profile isomer:deepsci/record-format/profile/paper/final-limitations-report/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'final summary and user' --payload-file <payload-file> --metadata-json '{"paper_surface":"final_limitations"}'` |
| DEEPSCI:FINAL-SUMMARY | report | Final summary Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/final-summary/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FINAL-SUMMARY' --format-profile isomer:deepsci/record-format/profile/paper/final-summary/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'user and future work' --payload-file <payload-file> --metadata-json '{"paper_surface":"final_summary"}'` |
| DEEPSCI:RESUME-PACKET | handoff | Resume packet package Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/package/paper/resume-packet/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:RESUME-PACKET' --format-profile isomer:deepsci/record-format/profile/package/paper/resume-packet/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'future work' --payload-file <payload-file> --metadata-json '{"paper_surface":"resume_packet"}'` |
| DEEPSCI:CLOSURE-DECISION | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/closure-decision/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:CLOSURE-DECISION' --format-profile isomer:deepsci/record-format/profile/decision/closure-decision/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize or decision' --consumer 'user and future work' --payload-file <payload-file> --metadata-json '{"paper_surface":"closure_decision"}'` |
| DEEPSCI:FINALIZE-BLOCKER-RECORD | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/finalize-blocker-record/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FINALIZE-BLOCKER-RECORD' --format-profile isomer:deepsci/record-format/profile/decision/finalize-blocker-record/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'decision or upstream skill' --payload-file <payload-file> --metadata-json '{"paper_surface":"finalize_blocker"}'` |
| DEEPSCI:FINALIZE-CONTINUITY-UPDATE | runtime state | Finalize continuity View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/finalize-continuity/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --semantic-id 'DEEPSCI:FINALIZE-CONTINUITY-UPDATE' --format-profile isomer:deepsci/record-format/profile/paper/finalize-continuity/v2 --skill isomer-deepsci-finalize --producer 'isomer-deepsci-finalize' --consumer 'future work' --payload-file <payload-file> --metadata-json '{"paper_surface":"finalize_continuity"}'` |
