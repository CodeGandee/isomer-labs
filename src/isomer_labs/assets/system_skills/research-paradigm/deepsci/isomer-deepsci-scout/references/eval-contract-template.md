...
- Downstream sufficiency: `isomer-deepsci-baseline`, `isomer-deepsci-idea`, and `isomer-deepsci-experiment` can use the contract without re-deriving task, split, metric, or fairness.
