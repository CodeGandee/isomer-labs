...
| --- | --- | --- | --- | --- | --- | --- |
| <PAPER_TYPE_DIAGNOSIS> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<PAPER_TYPE_DIAGNOSIS>' --format-profile isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing' --payload-file <payload-file> --metadata-json '{"paper_surface":"paper_type_diagnosis"}'` |
...
| <CLAIM_BOUNDARY_CHECK> | evidence | Claim boundary Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/claim-boundary-check/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --placeholder '<CLAIM_BOUNDARY_CHECK>' --format-profile isomer:deepsci/record-format/profile/paper/claim-boundary-check/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write, review' --payload-file <payload-file> --metadata-json '{"paper_surface":"claim_boundary_check"}'` |
| <SECTION_LOGIC_REBUILD> | draft | Section logic rebuild Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<SECTION_LOGIC_REBUILD>' --format-profile isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"section_logic_rebuild"}'` |
| <POLISHED_MANUSCRIPT_TEXT> | draft | Polished manuscript text Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<POLISHED_MANUSCRIPT_TEXT>' --format-profile isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'write, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"polished_manuscript_text"}'` |
| <POLISHING_STYLE_QA> | report | Manuscript language validation View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --placeholder '<POLISHING_STYLE_QA>' --format-profile isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"polishing_style_qa"}'` |
| <POLISHING_EVIDENCE_BLOCKER> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<POLISHING_EVIDENCE_BLOCKER>' --format-profile isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'user, write, decision' --payload-file <payload-file> --metadata-json '{"paper_surface":"polishing_evidence_blocker"}'` |
