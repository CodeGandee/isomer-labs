...
| --- | --- | --- | --- | --- | --- | --- |
| <PAPER_TYPE_DIAGNOSIS> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<PAPER_TYPE_DIAGNOSIS>' --format-profile isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v1 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing' --payload-file <payload-file> --metadata-json '{"paper_surface":"paper_type_diagnosis"}'` |
| <PROSE_FAILURE_DIAGNOSIS> | report | Prose failure diagnosis Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<PROSE_FAILURE_DIAGNOSIS>' --format-profile isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v1 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"prose_failure_diagnosis"}'` |
| <CLAIM_BOUNDARY_CHECK> | evidence | Claim boundary Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/claim-boundary-check/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --placeholder '<CLAIM_BOUNDARY_CHECK>' --format-profile isomer:deepsci/record-format/profile/paper/claim-boundary-check/v1 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write, review' --payload-file <payload-file> --metadata-json '{"paper_surface":"claim_boundary_check"}'` |
| <SECTION_LOGIC_REBUILD> | draft | Section logic rebuild Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<SECTION_LOGIC_REBUILD>' --format-profile isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v1 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"section_logic_rebuild"}'` |
