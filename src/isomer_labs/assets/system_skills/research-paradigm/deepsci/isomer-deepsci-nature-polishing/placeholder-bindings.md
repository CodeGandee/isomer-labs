...
| --- | --- | --- | --- | --- | --- | --- |
| DEEPSCI:PAPER-TYPE-DIAGNOSIS | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PAPER-TYPE-DIAGNOSIS' --format-profile isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing' --payload-file <payload-file> --metadata-json '{"paper_surface":"paper_type_diagnosis"}'` |
| DEEPSCI:PROSE-FAILURE-DIAGNOSIS | report | Prose failure diagnosis Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PROSE-FAILURE-DIAGNOSIS' --format-profile isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"prose_failure_diagnosis"}'` |
| DEEPSCI:CLAIM-BOUNDARY-CHECK | evidence | Claim boundary Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/claim-boundary-check/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:CLAIM-BOUNDARY-CHECK' --format-profile isomer:deepsci/record-format/profile/paper/claim-boundary-check/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write, review' --payload-file <payload-file> --metadata-json '{"paper_surface":"claim_boundary_check"}'` |
| DEEPSCI:SECTION-LOGIC-REBUILD | draft | Section logic rebuild Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:SECTION-LOGIC-REBUILD' --format-profile isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"section_logic_rebuild"}'` |
| DEEPSCI:POLISHED-MANUSCRIPT-TEXT | draft | Polished manuscript text Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:POLISHED-MANUSCRIPT-TEXT' --format-profile isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'write, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"polished_manuscript_text"}'` |
| DEEPSCI:POLISHING-STYLE-QA | report | Manuscript language validation View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --semantic-id 'DEEPSCI:POLISHING-STYLE-QA' --format-profile isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --metadata-json '{"paper_surface":"polishing_style_qa"}'` |
| DEEPSCI:POLISHING-EVIDENCE-BLOCKER | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:POLISHING-EVIDENCE-BLOCKER' --format-profile isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v2 --skill isomer-deepsci-nature-polishing --producer 'isomer-deepsci-nature-polishing' --consumer 'user, write, decision' --payload-file <payload-file> --metadata-json '{"paper_surface":"polishing_evidence_blocker"}'` |
