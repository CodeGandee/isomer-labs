...
- A validated comparator exists and the work is ready for `isomer-rsch-idea`, `isomer-rsch-experiment`, or `isomer-rsch-analysis`.
...
- Literature or repository context could change whether the next route is `isomer-rsch-baseline`, `isomer-rsch-idea`, `isomer-rsch-decision`, a Gate, or a blocker.
...
- `<NEXT_ROUTE_DECISION>` names `isomer-rsch-baseline`, `isomer-rsch-idea`, `isomer-rsch-decision`, a Gate, a blocker, or another justified production DeepSci route.
