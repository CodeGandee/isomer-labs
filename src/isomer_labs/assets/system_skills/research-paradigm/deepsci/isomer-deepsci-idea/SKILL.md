...
7. **Challenge serious candidates**. Write or refresh <PRE_IDEA_DRAFT> for the top serious candidates before formal promotion. Read `references/pre-idea-draft-template.md` and keep hidden assumptions, local-optimum risk, strongest rejection case, and cheapest falsification path explicit.
