...
| --- | --- | --- | --- | --- | --- | --- |
| DEEPSCI:PAPER-PRESENTATION-SOURCE-PACKET | evidence | Presentation source-packet Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/source-packet/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PAPER-PRESENTATION-SOURCE-PACKET' --format-profile isomer:deepsci/record-format/profile/presentation/source-packet/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt' --payload-file <payload-file> --metadata-json '{"paper_surface":"presentation_source_packet"}'` |
| DEEPSCI:PAPER-TYPE-CLASSIFICATION | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/paper-type-classification/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PAPER-TYPE-CLASSIFICATION' --format-profile isomer:deepsci/record-format/profile/decision/paper-type-classification/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt' --payload-file <payload-file> --metadata-json '{"paper_surface":"paper_type_classification"}'` |
| DEEPSCI:CHINESE-PRESENTATION-PLAN | draft | Chinese presentation plan Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/plan/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:CHINESE-PRESENTATION-PLAN' --format-profile isomer:deepsci/record-format/profile/presentation/plan/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"chinese_presentation_plan"}'` |
| DEEPSCI:PRESENTATION-FIGURE-SELECTION | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/presentation-figure-selection/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PRESENTATION-FIGURE-SELECTION' --format-profile isomer:deepsci/record-format/profile/decision/presentation-figure-selection/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt' --payload-file <payload-file> --metadata-json '{"paper_surface":"presentation_figure_selection"}'` |
| DEEPSCI:PRESENTATION-ASSET-MANIFEST | figure | Presentation asset manifest Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/asset-manifest/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PRESENTATION-ASSET-MANIFEST' --format-profile isomer:deepsci/record-format/profile/presentation/asset-manifest/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"presentation_asset_manifest"}'` |
| DEEPSCI:CHINESE-SLIDE-CONTENT | draft | Chinese slide content Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/slide-content/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:CHINESE-SLIDE-CONTENT' --format-profile isomer:deepsci/record-format/profile/presentation/slide-content/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'nature-paper2ppt, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"chinese_slide_content"}'` |
| DEEPSCI:PPTX-DECK | report | PPTX deck package Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/package/presentation/pptx-deck/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PPTX-DECK' --format-profile isomer:deepsci/record-format/profile/package/presentation/pptx-deck/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'user' --payload-file <payload-file> --metadata-json '{"paper_surface":"pptx_deck"}'` |
| DEEPSCI:PPTX-QA-REPORT | report | PPTX QA report Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/qa-report/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PPTX-QA-REPORT' --format-profile isomer:deepsci/record-format/profile/presentation/qa-report/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'user' --payload-file <payload-file> --metadata-json '{"paper_surface":"pptx_qa_report"}'` |
| DEEPSCI:PPTX-REVISION-LOG | report | PPTX revision log Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/presentation/revision-log/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:PPTX-REVISION-LOG' --format-profile isomer:deepsci/record-format/profile/presentation/revision-log/v2 --skill isomer-deepsci-nature-paper2ppt --producer 'isomer-deepsci-nature-paper2ppt' --consumer 'user' --payload-file <payload-file> --metadata-json '{"paper_surface":"pptx_revision_log"}'` |
