...
| --- | --- | --- | --- | --- | --- | --- |
| <DATA_AVAILABILITY_CONTEXT> | runtime state | Data availability context View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/data-availability-context/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --placeholder '<DATA_AVAILABILITY_CONTEXT>' --format-profile isomer:deepsci/record-format/profile/paper/data-availability-context/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_context"}'` |
| <DATASET_INVENTORY> | evidence | Dataset inventory Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/dataset-inventory/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --placeholder '<DATASET_INVENTORY>' --format-profile isomer:deepsci/record-format/profile/paper/dataset-inventory/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data, write, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"dataset_inventory"}'` |
| <DATA_ACCESS_CLASSIFICATION> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/data-access-classification/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<DATA_ACCESS_CLASSIFICATION>' --format-profile isomer:deepsci/record-format/profile/decision/data-access-classification/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_access_classification"}'` |
| <REPOSITORY_STRATEGY> | handoff | Data repository strategy Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/data-repository-strategy/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<REPOSITORY_STRATEGY>' --format-profile isomer:deepsci/record-format/profile/paper/data-repository-strategy/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"repository_strategy"}'` |
| <DATA_AVAILABILITY_STATEMENT> | draft | Data availability statement Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/data-availability-statement/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<DATA_AVAILABILITY_STATEMENT>' --format-profile isomer:deepsci/record-format/profile/paper/data-availability-statement/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'write, finalize, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_statement"}'` |
...
| <DATA_AVAILABILITY_BLOCKER> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/data-availability-blocker/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<DATA_AVAILABILITY_BLOCKER>' --format-profile isomer:deepsci/record-format/profile/decision/data-availability-blocker/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'user, decision, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_blocker"}'` |
