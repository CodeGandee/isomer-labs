...
| --- | --- | --- | --- | --- | --- | --- |
| DEEPSCI:DATA-AVAILABILITY-CONTEXT | runtime state | Data availability context View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/data-availability-context/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --semantic-id 'DEEPSCI:DATA-AVAILABILITY-CONTEXT' --format-profile isomer:deepsci/record-format/profile/paper/data-availability-context/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_context"}'` |
| DEEPSCI:DATASET-INVENTORY | evidence | Dataset inventory Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/dataset-inventory/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:DATASET-INVENTORY' --format-profile isomer:deepsci/record-format/profile/paper/dataset-inventory/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data, write, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"dataset_inventory"}'` |
| DEEPSCI:DATA-ACCESS-CLASSIFICATION | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/data-access-classification/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:DATA-ACCESS-CLASSIFICATION' --format-profile isomer:deepsci/record-format/profile/decision/data-access-classification/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_access_classification"}'` |
| DEEPSCI:REPOSITORY-STRATEGY | handoff | Data repository strategy Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/data-repository-strategy/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:REPOSITORY-STRATEGY' --format-profile isomer:deepsci/record-format/profile/paper/data-repository-strategy/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"repository_strategy"}'` |
| DEEPSCI:DATA-AVAILABILITY-STATEMENT | draft | Data availability statement Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/data-availability-statement/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:DATA-AVAILABILITY-STATEMENT' --format-profile isomer:deepsci/record-format/profile/paper/data-availability-statement/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'write, finalize, user' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_statement"}'` |
| DEEPSCI:DATASET-CITATION-ACTIONS | report | Dataset citation actions Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/dataset-citation-actions/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:DATASET-CITATION-ACTIONS' --format-profile isomer:deepsci/record-format/profile/paper/dataset-citation-actions/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'write, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"dataset_citation_actions"}'` |
| DEEPSCI:FAIR-METADATA-AUDIT | report | FAIR metadata audit Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/fair-metadata-audit/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FAIR-METADATA-AUDIT' --format-profile isomer:deepsci/record-format/profile/paper/fair-metadata-audit/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'nature-data, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"fair_metadata_audit"}'` |
| DEEPSCI:DATA-AVAILABILITY-BLOCKER | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/data-availability-blocker/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:DATA-AVAILABILITY-BLOCKER' --format-profile isomer:deepsci/record-format/profile/decision/data-availability-blocker/v2 --skill isomer-deepsci-nature-data --producer 'isomer-deepsci-nature-data' --consumer 'user, decision, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"data_availability_blocker"}'` |
