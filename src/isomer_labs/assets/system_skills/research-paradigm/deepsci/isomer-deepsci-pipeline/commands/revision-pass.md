...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | audit | `isomer-deepsci-review` | `draft-section-set` | `review-report` | `route_decision == revise` | `route_decision != revise` | no |
| 2 | fill_gaps | `isomer-deepsci-analysis` | `review-report`, `draft-section-set` | `analysis-finding` | `route_decision` in `[write, finalize]` | blocker exists | no |
| 3 | revise | `isomer-deepsci-write` | `analysis-finding`, `draft-section-set` | `revised-draft` | manuscript validation passes | blocker exists | no |
