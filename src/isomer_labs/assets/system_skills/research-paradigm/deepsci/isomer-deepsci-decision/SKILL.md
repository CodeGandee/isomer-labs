...
5. **Record the verdict**. Create <ROUTE_DECISION_RECORD> with verdict, action, reason, evidence, rejected alternatives, next route, and `follow_up_to` or `selected_from` lineage from the decisive parent records. Read `references/strategic-decision-template.md`.
