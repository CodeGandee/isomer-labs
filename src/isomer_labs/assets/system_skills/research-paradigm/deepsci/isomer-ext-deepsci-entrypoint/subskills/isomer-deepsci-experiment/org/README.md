# Isomer Research Experiment Production DeepSci Migration Provenance

This directory preserves the upstream DeepScientist `experiment` source and the analysis used to refactor it into `isomer-rsch-experiment`.
