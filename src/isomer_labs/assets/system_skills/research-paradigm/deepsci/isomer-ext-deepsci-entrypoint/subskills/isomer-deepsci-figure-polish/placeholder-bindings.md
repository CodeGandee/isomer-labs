...
| --- | --- | --- | --- | --- | --- | --- |
| DEEPSCI:FIGURE-SURFACE-CLASS | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/figure-surface-class/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FIGURE-SURFACE-CLASS' --format-profile isomer:deepsci/record-format/profile/decision/figure-surface-class/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'figure-polish' --payload-file <payload-file> --metadata-json '{"paper_surface":"figure_surface_class"}'` |
| DEEPSCI:FIGURE-MESSAGE | handoff | Figure message Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/figure/message/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FIGURE-MESSAGE' --format-profile isomer:deepsci/record-format/profile/figure/message/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'figure-polish, write, review' --payload-file <payload-file> --metadata-json '{"paper_surface":"figure_message"}'` |
| DEEPSCI:FIGURE-STYLE-CONTRACT | report | Figure style-contract Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/figure/style-contract/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FIGURE-STYLE-CONTRACT' --format-profile isomer:deepsci/record-format/profile/figure/style-contract/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'figure-polish' --payload-file <payload-file> --metadata-json '{"paper_surface":"figure_style_contract"}'` |
| DEEPSCI:FIGURE-RENDER-REVIEW | report | Figure render-review Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/figure/render-review/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FIGURE-RENDER-REVIEW' --format-profile isomer:deepsci/record-format/profile/figure/render-review/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'figure-polish' --payload-file <payload-file> --metadata-json '{"paper_surface":"figure_render_review"}'` |
| DEEPSCI:FINAL-FIGURE-EXPORT | figure | Final figure export Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/figure/export/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FINAL-FIGURE-EXPORT' --format-profile isomer:deepsci/record-format/profile/figure/export/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'write, review, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"final_figure_export"}'` |
| DEEPSCI:FIGURE-PROVENANCE-RECORD | provenance | Figure provenance Record | `provenance_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/figure/provenance-record/v2` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind provenance_record --semantic-label topic.records.artifacts --semantic-id 'DEEPSCI:FIGURE-PROVENANCE-RECORD' --format-profile isomer:deepsci/record-format/profile/figure/provenance-record/v2 --skill isomer-deepsci-figure-polish --producer 'isomer-deepsci-figure-polish' --consumer 'write, review, finalize' --payload-file <payload-file> --metadata-json '{"paper_surface":"figure_provenance"}'` |
