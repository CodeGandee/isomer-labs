# Isomer Research Decision Production DeepSci Refactor Migration Plan
...
- `DEEPSCI:DECISION-CONTEXT-BRIEF`
- `DEEPSCI:ROUTE-QUESTION`
- `DEEPSCI:DECISION-EVIDENCE-PACKET`
- `DEEPSCI:ROUTE-DECISION-RECORD`
- `DEEPSCI:DECISION-CHECKPOINT-MEMORY`
- `DEEPSCI:USER-DECISION-REQUEST`
- `DEEPSCI:DECISION-BLOCKER-RECORD`

## Unmatched Skill-Route Substitutions

decision maps to isomer-rsch-decision. Source canonical actions map to production DeepSci skills or placeholders for missing paper/write/review surfaces.
