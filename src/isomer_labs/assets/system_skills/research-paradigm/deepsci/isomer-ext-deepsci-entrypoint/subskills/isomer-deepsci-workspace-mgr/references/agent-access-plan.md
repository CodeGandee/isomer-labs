...
2. Resolve Topic Actor Workspace context for human-orchestrated workers and Agent Workspace context for formal team agents that will participate in the production DeepSci research loop.
