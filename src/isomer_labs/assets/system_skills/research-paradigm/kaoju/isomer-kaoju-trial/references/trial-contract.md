...
Each attempt is a new Run. The result records exact inputs, command request, logs, outputs, timing, resource observations, fidelity, verdict, verification depth, adaptations, failures, and limitations. Later attempts never overwrite earlier evidence.
