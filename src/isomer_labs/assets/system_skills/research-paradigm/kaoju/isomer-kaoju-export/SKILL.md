...
Resolve bindings through `ext kaoju bindings describe KAOJU:WHAT` and persist only through typed Artifact operations. Read `artifact-bindings.md`, `references/wiki-contract.md`, and `$isomer-kaoju-shared` before mutation.
