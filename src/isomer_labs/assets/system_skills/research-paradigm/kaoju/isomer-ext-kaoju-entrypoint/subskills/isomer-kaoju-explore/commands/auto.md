...
5. **Resolve plan review**. Ask for human consent by default. If the current prompt explicitly delegates plan review and handoff for the named target, review and revise the plan and hand off without another user turn; otherwise stop and return a paused recommendation when consent is absent.
