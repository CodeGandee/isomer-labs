...
- `document_build` policy, pinned-snapshot and entrypoint checks, permitted TeX engines, repair classification, output form, quality checks, and publication Gate.
