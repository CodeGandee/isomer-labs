...
Use the independently installed `$isomer-research-idea-recording` skill as the authoritative portfolio contract. This page maps Kaoju profiles to that contract and does not depend on DeepSci.
