...
- Route user-facing or research-skill package install, update, remove, or package verification handoffs to the matching `$isomer-op-topic-mgr env-*` command unless the user explicitly requests the full gate-driven setup workflow.
