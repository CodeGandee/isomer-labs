...
3. Create or refine actor definitions with each actor's name, duty, intended usage, expected cwd label, actor kind, runtime kind, role kind, controller kind, source env gate requirements, and open actor setup questions.
