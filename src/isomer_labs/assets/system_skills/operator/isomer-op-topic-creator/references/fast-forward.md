...
11. Run `finalize` to validate Topic Workspace preparation, write `topic.workspace.summary`, and print ready/verified/blocked state.
12. Report Essential Output by default, including the blocked stage and missing evidence if any stage blocked.
