...
4. Call `isomer-cli project system-extensions remember <extension-id> --json` only for each pack whose explicit-root inspection reports a current v4 receipt, complete protected nested coverage, managed receipt evidence, and usable compatibility.
