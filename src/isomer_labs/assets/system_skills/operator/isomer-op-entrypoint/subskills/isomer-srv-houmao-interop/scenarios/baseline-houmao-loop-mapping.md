...
You are handling a bounded Houmao interop Service Request from the Isomer Labs Project Operator Agent. You have access to the project root at `/data/huangzhe/code/isomer-labs`. The operator asks:
...
- Produce a concise markdown report with:
  ...
  3. A list of concrete files service support would identify for an operator-approved stage-skill change.
