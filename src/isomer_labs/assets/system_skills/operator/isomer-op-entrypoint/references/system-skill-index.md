...
| System-skill extension detection, reconciliation, installation, status, registration, compatibility diagnosis, or repair. | `isomer-op-system-skill-mgr` | `Use $isomer-op-system-skill-mgr detect-extensions`, `reconcile-extensions`, `install-extension`, `status`, or `repair`. |
