...
2. Read finalization inputs:
   - Reused common preparation refs when present, including `isomer-admin-topic-creator` summaries, Topic Workspace refs, Workspace Runtime readiness, topic environment readiness, topic-main readiness, current Topic Actor roster, and Topic Actor Workspace refs.
