...
3. **Author or update source files** with [author-toolbox-source.md](author-toolbox-source.md) when callback material is missing.
...
7. **Report Essential Output** with target skill, stage, Toolbox ID, local key, installed callback id, scope, validation result, and blockers.
