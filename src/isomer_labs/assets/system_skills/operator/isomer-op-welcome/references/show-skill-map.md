...
2. Include all active owner skills: `isomer-op-project-mgr`, `isomer-op-switch-identity`, `isomer-op-toolbox-mgr`, `isomer-op-topic-creator`, `isomer-op-topic-mgr`, and `isomer-op-topic-team-specialize`.
