...
4. Show additional supported actions: Project setup or checks, switched Topic Actor or Agent workspace cwd work, initialized-topic management, and Topic Team Specialization. Do not present service skills as direct first-click owner routes.
