...
STORAGE_PROFILES = (
    ...
    StorageProfile("topic_derived_intent_dir", "topic", "directory", "durable", "topic", "topic_workspace_local", "topic"),
...
SEMANTIC_SURFACES = (
    ...
    _surface("topic.intent.kaoju_mindsets", "topic", "topic_intent_kaoju_mindsets", "intent/derived/mindsets", "topic_derived_intent_dir"),
