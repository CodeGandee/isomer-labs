...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-decision`, `isomer-deepsci-finalize`.
- Optional skills: `isomer-deepsci-review` when the master must inspect a review handoff before opening a Gate.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-scout`, `isomer-deepsci-baseline`.
- Optional skills: `isomer-deepsci-science` for package or environment checks, `isomer-deepsci-paper-outline` when the frame must state paper evidence needs early.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-idea`, `isomer-deepsci-optimize`.
- Optional skills: `isomer-deepsci-scout` for narrow literature checks that change idea selection.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-experiment`, `isomer-deepsci-science`.
- Optional skills: `isomer-deepsci-analysis` for tiny post-run checks that do not justify a separate analyzer handoff.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-analysis`, `isomer-deepsci-science`.
- Optional skills: `isomer-deepsci-paper-plot`, `isomer-deepsci-figure-polish` for analysis-facing result displays.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-paper-outline`, `isomer-deepsci-write`, `isomer-deepsci-paper-plot`, `isomer-deepsci-figure-polish`.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-review`, `isomer-deepsci-rebuttal`, `isomer-deepsci-analysis`.
- Optional skills: `isomer-deepsci-scout` for novelty benchmarking and comparator-paper checks.
