...
- Optional skills: `isomer-rsch-review-v1` when the master must inspect a review handoff before opening a Gate.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-scout-v2`, `isomer-rsch-baseline-v2`.
- Optional skills: `isomer-rsch-science-v2` for package or environment checks, `isomer-rsch-paper-outline-v1` when the frame must state paper evidence needs early.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-idea-v2`, `isomer-rsch-optimize-v2`.
- Optional skills: `isomer-rsch-scout-v2` for narrow literature checks that change idea selection.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-experiment-v2`, `isomer-rsch-science-v2`.
- Optional skills: `isomer-rsch-analysis-v2` for tiny post-run checks that do not justify a separate analyzer handoff.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-analysis-v2`, `isomer-rsch-science-v2`.
- Optional skills: `isomer-rsch-paper-plot-v1`, `isomer-rsch-figure-polish-v1` for analysis-facing result displays.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-paper-outline-v1`, `isomer-rsch-write-v1`, `isomer-rsch-paper-plot-v1`, `isomer-rsch-figure-polish-v1`.
...
- Required skills: `isomer-rsch-shared-v2`, `isomer-rsch-review-v1`, `isomer-rsch-rebuttal-v1`, `isomer-rsch-analysis-v2`.
- Optional skills: `isomer-rsch-scout-v2` for novelty benchmarking and comparator-paper checks.
