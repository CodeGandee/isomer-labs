...
- Optional skills: `isomer-deepsci-review` for a final skeptical pass when `deepsci-mini-synth-reviewer` flags a serious evidence boundary.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-scout`.
- Optional skills: `isomer-deepsci-baseline`, `isomer-deepsci-science`, and `isomer-deepsci-paper-outline` when the topic needs comparator context, scientific package checks, or early paper-facing evidence boundaries.
...
- Required skills: `isomer-deepsci-shared`, `isomer-deepsci-idea`, `isomer-deepsci-analysis`, `isomer-deepsci-review`.
- Optional skills: `isomer-deepsci-science` for domain validation and `isomer-deepsci-paper-plot` when a lightweight diagnostic view is needed.
