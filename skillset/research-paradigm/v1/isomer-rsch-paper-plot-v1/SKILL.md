---
name: isomer-rsch-paper-plot-v1
...
7. **Route the result**. Keep it as a first-pass figure, or hand durable milestone, report, review, appendix, or manuscript figures to `$isomer-rsch-figure-polish-v1`.
...
- The handoff either keeps the figure as first-pass output or routes it to `$isomer-rsch-figure-polish-v1`.
