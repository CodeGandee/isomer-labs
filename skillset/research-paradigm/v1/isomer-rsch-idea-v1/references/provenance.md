...
This skill adapts the DeepScientist `idea` research method and reference material into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: objective contracts, current-board packets, history-aware literature survey, related-work comparison, high-value idea sourcing, thinking flow, controlled brainstorming, pre-idea drafts, selection gates, and paper-outline seeding.
...
- paper lookup became Literature Provider Binding refs.
