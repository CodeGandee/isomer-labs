...
If a claim lacks evidence, route to `isomer-rsch-analysis-v1` or downgrade the claim. If novelty or positioning is uncertain, route to `isomer-rsch-scout-v1`. If a comparator is missing, route to `isomer-rsch-baseline-v1`. If scope choice is non-trivial, route to `isomer-rsch-decision-v1`.
