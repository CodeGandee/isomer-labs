...
Use this skill when a Research Inquiry or Research Task already has drafts, baselines, runs, reviews, files, or user-provided state and the next Workflow Stage Cursor is not trustworthy yet.
...
7. **Compile one current-board packet and route the handoff** with the trusted mainline, active blocker, stale routes to ignore, budget class, recommended Workflow Stage Cursor, Gate, Decision Record, or blocker.
...
- `references/intake-routing.md` when choosing the next Workflow Stage Cursor, Gate, Decision Record, or blocker.
...
- The Operator Agent needs a recommended next Workflow Stage Cursor, Gate, Decision Record, or blocker.
...
- The handoff names the recommended next Workflow Stage Cursor, Gate, Decision Record, or blocker.
