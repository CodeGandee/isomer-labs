...
Use this skill when a selected route needs algorithm-first candidate shaping, frontier ranking, Research Inquiry Relationship promotion, bounded implementation attempts, fusion, debug, or stop decisions before or after a measured Run.
...
- `references/candidate-ranking.md` before promoting a candidate brief into a durable Research Inquiry Relationship.
...
- Candidate method briefs or Research Inquiry Relationships exist but promotion criteria are unclear.
