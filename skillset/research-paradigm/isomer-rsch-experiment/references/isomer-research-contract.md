...
When a source behavior implies execution, storage, state mutation, monitoring, chart generation, or run recording, describe the intended Isomer record or capability and mark the concrete surface as unsettled.
