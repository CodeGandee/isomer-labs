...
This skill adapts the DeepScientist `finalize` research method and reference material into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: closure preconditions, accepted-evidence consolidation, final claim ledger, limitations and failure reporting, package inventory, resume packet, completion gate discipline, route-back conditions, and finalization-quality checks.
