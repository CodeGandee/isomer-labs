...
| command wrapper | Execution Adapter Command Request with applicable extension, capability, policy, workspace, and recording refs |
| HPC through shell | SSH, scheduler, queue, and log work through Execution Adapter Command Requests with Scheduler Policy and Gate Policy refs |
