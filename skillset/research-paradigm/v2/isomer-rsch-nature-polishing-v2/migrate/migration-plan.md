...
- Target skill: `skillset/research-paradigm/v2/isomer-rsch-nature-polishing-v2`.
...
- write maps to `isomer-rsch-write-v2` for larger manuscript drafting.
- review maps to `isomer-rsch-review-v2` for independent audit.
- rebuttal maps to `isomer-rsch-rebuttal-v2` for reviewer-response text.
