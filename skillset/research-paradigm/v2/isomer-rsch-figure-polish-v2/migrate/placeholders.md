...
| --- | --- | --- | --- | --- | --- |
| <FIGURE_SURFACE_CLASS> | milestone, paper main, appendix, internal review | The surface class that controls strictness and export format. | isomer-rsch-figure-polish-v2 | figure-polish | decision |
| <FIGURE_MESSAGE> | one dominant message | The one claim or comparison the figure must communicate. | isomer-rsch-figure-polish-v2 | figure-polish, write, review | handoff |
