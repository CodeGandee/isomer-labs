...
4. Build <RSCH_STORAGE_LABEL_PLAN> with each semantic label, availability, intended placeholder kinds, current access command or blocker, and notes for later typed record commands.
5. Refuse hard-coded fallback paths when a semantic label is missing; create <RSCH_WORKSPACE_BLOCKER_RECORD> instead.
