...
description: Use after Topic Workspace and Topic Actor preparation, and optionally after Topic Team preparation, to own v2 research workspace bootstrap, selected v2 skill readiness, placeholder binding readiness, worker access posture, accepted research artifact guidance, and bootstrap validation before ordinary v2 research skills write durable outputs.
---
...
1. **Confirm bootstrap entry**. Build <RSCH_WORKSPACE_CONTEXT> from minimal readiness signals across base Topic Workspace, selected Topic Actor, selected v2 skill set, and optional formal team layers. Read `references/bootstrap-workflow.md`.
...
- Readiness-signal coverage: fraction of base Topic Workspace readiness, selected Topic Actor readiness, selected v2 skill readiness, optional formal team readiness, Workspace Runtime readiness, record-label readiness, placeholder binding guidance, and worker identity checked before bootstrap; higher is better.
...
- Entry check: <RSCH_WORKSPACE_CONTEXT> confirms base Topic Workspace readiness, selected Topic Actor readiness, selected v2 skill readiness, and optional formal team readiness using minimal readiness signals rather than broad fragile file detection.
