...
- Target skill: `skillset/research-paradigm/v2/isomer-rsch-paper-plot-v2`.
...
- If the figure is paper-facing, appendix-facing, milestone-facing, or final, create <FIGURE_POLISH_HANDOFF> for isomer-rsch-figure-polish-v2; otherwise stop with the first-pass figure and substitution record.
