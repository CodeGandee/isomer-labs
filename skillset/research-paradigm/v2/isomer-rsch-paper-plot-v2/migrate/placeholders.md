...
| <PLOT_RENDER_INSPECTION> | inspect rendered output | Visual QA note from inspecting the actual first-pass render. | isomer-rsch-paper-plot-v2 | paper-plot, figure-polish | evidence |
