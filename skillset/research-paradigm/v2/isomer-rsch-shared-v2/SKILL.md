...
- A post-specialization Topic Workspace needs a v2 research bootstrap pass before ordinary v2 skills write durable outputs.
...
4. **Route bootstrap questions**. Use `isomer-rsch-workspace-mgr-v2` when the issue is post-specialization placeholder binding, semantic record surfaces, Agent Workspace access posture, or missing bootstrap support. Read `references/coordination-contract.md`.
...
- Treating shared as the post-specialization bootstrap manager instead of routing to `isomer-rsch-workspace-mgr-v2`.
...
Read `references/semantic-placeholders.md` whenever a v2 skill needs shared handoff vocabulary. Read `references/coordination-contract.md` whenever the question is about ownership, routing, unresolved storage binding, post-specialization bootstrap routing, or handoff shape.
...
- Bootstrap check: post-specialization workspace bootstrap questions route to `isomer-rsch-workspace-mgr-v2`.
