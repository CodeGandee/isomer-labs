# Isomer Research Science V2 Migration Provenance

This directory preserves the upstream DeepScientist `science` source and the analysis used to refactor it into `isomer-rsch-science-v2`.
