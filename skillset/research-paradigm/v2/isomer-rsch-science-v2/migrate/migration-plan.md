...
| companion skill | v2 companion support skill for scientific evidence discipline. |
| next stage or next anchor | `<SCIENCE_ROUTE_DECISION>` or `<SCIENCE_BLOCKER_RECORD>`, later bound to v2 skill routing. |
...
science maps to isomer-rsch-science-v2. Source science evidence graph calls map to local science evidence placeholders and compatibility extension calls when required.
...
- `references/science-task-brief.md`, `references/evidence-recording.md`, `references/package-routing.md`, `references/hpc-execution-adapter.md`, `references/claim-discipline.md`: compatibility pages from the first v2 draft pointing to source-preserved pages.
