# Isomer Research Baseline V2 Migration Provenance

This directory preserves the upstream DeepScientist `baseline` source and the analysis used to refactor it into `isomer-rsch-baseline-v2`.
