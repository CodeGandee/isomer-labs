...
| next stage or next anchor | `<BASELINE_ROUTE_DECISION>` or `<BASELINE_BLOCKER_RECORD>`, later bound to v2 skill routing. |
...
- `references/verification-record-template.md`: v2 support page distilled from source verification, objective evidence, and acceptance-gate rules.
