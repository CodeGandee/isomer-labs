...
| <REVIEWER_LINKED_EVIDENCE_TODO> | reviewer-linked experiment/action TODOs | Concrete reviewer-id-linked evidence work. | isomer-rsch-rebuttal-v2 | analysis, experiment, decision | handoff |
