# Isomer Research Optimize V2 Migration Provenance

This directory preserves the upstream DeepScientist `optimize` source and the analysis used to refactor it into `isomer-rsch-optimize-v2`.
