...
- `references/frontier-management.md`: Frontier Management.
- `references/candidate-brief-template.md`: Candidate Brief Template.
- `references/candidate-ranking.md`: Candidate Ranking.
- `references/run-recording.md`: Optimization Attempt Recording.
- `references/plateau-and-fusion.md`: Plateau and Fusion.
...
- Frontier recovered.
- One submode selected.
- Candidate briefs distinct from lines.
- Plateau triggers route review.
- Exactly one next route or blocker recorded.
