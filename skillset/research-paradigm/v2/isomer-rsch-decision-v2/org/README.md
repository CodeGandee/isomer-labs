# Isomer Research Decision V2 Migration Provenance

This directory preserves the upstream DeepScientist `decision` source and the analysis used to refactor it into `isomer-rsch-decision-v2`.
