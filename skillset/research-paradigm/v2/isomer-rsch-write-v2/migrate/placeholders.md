...
| <WRITING_PLAN> | compiled section jobs | Section-level writing jobs with inputs, claim limits, display needs, and stop criteria. | isomer-rsch-write-v2 | write | report |
