...
- Target skill: `skillset/research-paradigm/v2/isomer-rsch-write-v2`.
...
- paper-outline maps to `isomer-rsch-paper-outline-v2`.
- paper-plot maps to `isomer-rsch-paper-plot-v2`.
- figure-polish maps to `isomer-rsch-figure-polish-v2`.
- analysis-campaign maps to `isomer-rsch-analysis-v2`.
- review maps to `isomer-rsch-review-v2`.
- finalize maps to `isomer-rsch-finalize-v2`.
- nature-data, nature-figure, nature-paper2ppt, and nature-polishing map to their v2 companion skills.
