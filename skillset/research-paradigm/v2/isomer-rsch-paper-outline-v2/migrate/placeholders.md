...
| --- | --- | --- | --- | --- | --- |
| <PAPER_STATE_SNAPSHOT> | current outline, paper contract, evidence surfaces | The source state for outline creation or repair. | isomer-rsch-paper-outline-v2 | paper-outline, write | runtime state |
| <ONE_SENTENCE_PAPER_IDEA> | one-sentence paper idea | The concise reader-facing claim the paper should make memorable. | isomer-rsch-paper-outline-v2 | paper-outline, write, review | draft |
| <CLAIM_EVIDENCE_BOUNDARY> | facts versus interpretation | Allowed claims, supporting evidence, limitations, and falsification boundaries. | isomer-rsch-paper-outline-v2 | write, review, rebuttal | evidence |
