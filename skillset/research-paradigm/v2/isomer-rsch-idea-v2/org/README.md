# Isomer Research Idea V2 Migration Provenance

This directory preserves the upstream DeepScientist `idea` source and the analysis used to refactor it into `isomer-rsch-idea-v2`.
