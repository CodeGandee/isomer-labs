# Isomer Research Analysis V2 Migration Provenance

This directory preserves the upstream DeepScientist `analysis-campaign` source and the analysis used to refactor it into `isomer-rsch-analysis-v2`.
