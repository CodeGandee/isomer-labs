# Isomer Research Finalize V2 Migration Provenance

This directory preserves the upstream DeepScientist `finalize` source and the analysis used to refactor it into `isomer-rsch-finalize-v2`.
