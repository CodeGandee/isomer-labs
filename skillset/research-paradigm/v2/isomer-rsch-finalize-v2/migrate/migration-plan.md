# Isomer Research Finalize V2 Refactor Migration Plan

## Scope

- Source skill: `extern/orphan/DeepScientist/src/skills/finalize`.
- Target skill: `skillset/research-paradigm/v2/isomer-rsch-finalize-v2`.
...
finalize maps to isomer-rsch-finalize-v2. Source closure routes map to closure decisions and route-back placeholders when evidence gates fail.
