...
| --- | --- | --- | --- | --- | --- | --- |
| <REVIEW_AUDIT_PLAN> | report | Review audit-plan Artifact | `artifact` | `topic.records.artifacts` | `review.audit-plan` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<REVIEW_AUDIT_PLAN>' --profile review.audit-plan --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'review' --body-file <body-file> --content-name review-audit-plan.md --metadata-json '{"paper_surface":"review_audit_plan"}'` |
| <LITERATURE_BENCHMARK_NOTE> | evidence | Literature benchmark Evidence Item | `evidence_item` | `topic.records.artifacts` | `review.literature-benchmark-note` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --placeholder '<LITERATURE_BENCHMARK_NOTE>' --profile review.literature-benchmark-note --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'review, scout, write' --body-file <body-file> --content-name literature-benchmark-note.md --metadata-json '{"paper_surface":"literature_benchmark_note"}'` |
| <REVIEW_REPORT> | report | Review report Artifact | `artifact` | `topic.records.artifacts` | `review.report` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<REVIEW_REPORT>' --profile review.report --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, rebuttal, finalize' --body-file <body-file> --content-name review-report.md --metadata-json '{"paper_surface":"review_report"}'` |
| <REVISION_LOG> | handoff | Revision log Artifact | `artifact` | `topic.records.artifacts` | `review.revision-log` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<REVISION_LOG>' --profile review.revision-log --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, analysis, decision' --body-file <body-file> --content-name revision-log.md --metadata-json '{"paper_surface":"revision_log"}'` |
| <REVIEW_EXPERIMENT_TODO> | research task | Research Task for review-requested experiment work | `research_task` | `topic.records.tasks` | `review.experiment-todo` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind research_task --semantic-label topic.records.tasks --placeholder '<REVIEW_EXPERIMENT_TODO>' --profile review.experiment-todo --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'analysis, experiment, decision' --body-file <body-file> --content-name review-experiment-todo.json --metadata-json '{"paper_surface":"review_experiment_todo"}'` |
| <PAPER_EXPERIMENT_MATRIX_UPDATE> | runtime state | Paper experiment-matrix View Manifest | `view_manifest` | `topic.records.views` | `paper.experiment-matrix` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --placeholder '<PAPER_EXPERIMENT_MATRIX_UPDATE>' --profile paper.experiment-matrix --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, analysis, rebuttal' --body-file <body-file> --content-name paper-experiment-matrix-update.json --metadata-json '{"paper_surface":"experiment_matrix_update"}'` |
| <REVIEW_ROUTE_DECISION> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `decision.review-route-decision` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<REVIEW_ROUTE_DECISION>' --profile decision.review-route-decision --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'any selected v2 skill' --body-file <body-file> --metadata-json '{"paper_surface":"review_route_decision"}'` |
