...
| --- | --- | --- | --- | --- | --- | --- |
| <REVIEW_AUDIT_PLAN> | report | Artifact with a report profile | `artifact` | `topic.records.artifacts` | `report.review-audit-plan` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<REVIEW_AUDIT_PLAN>' --profile report.review-audit-plan --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'review' --body-file <body-file>` |
| <LITERATURE_BENCHMARK_NOTE> | evidence | Evidence Item with an Artifact body when the evidence needs rich content | `evidence_item` | `topic.records.artifacts` | `evidence.literature-benchmark-note` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --placeholder '<LITERATURE_BENCHMARK_NOTE>' --profile evidence.literature-benchmark-note --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'review, scout, write' --body-file <body-file>` |
| <REVIEW_REPORT> | report | Artifact with a report profile | `artifact` | `topic.records.artifacts` | `report.review-report` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<REVIEW_REPORT>' --profile report.review-report --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, rebuttal, finalize' --body-file <body-file>` |
| <REVISION_LOG> | handoff | Handoff packet Artifact, or Handoff Record when dispatching across agents | `artifact` | `topic.records.artifacts` | `handoff.revision-log` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<REVISION_LOG>' --profile handoff.revision-log --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, analysis, decision' --body-file <body-file>` |
| <REVIEW_EXPERIMENT_TODO> | handoff | Handoff packet Artifact, or Handoff Record when dispatching across agents | `artifact` | `topic.records.artifacts` | `handoff.review-experiment-todo` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --placeholder '<REVIEW_EXPERIMENT_TODO>' --profile handoff.review-experiment-todo --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'analysis, experiment, decision' --body-file <body-file>` |
| <PAPER_EXPERIMENT_MATRIX_UPDATE> | runtime state | View Manifest, Workflow Stage Cursor, or control Artifact | `view_manifest` | `topic.records.views` | `control.paper-experiment-matrix-update` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --placeholder '<PAPER_EXPERIMENT_MATRIX_UPDATE>' --profile control.paper-experiment-matrix-update --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'write, analysis, rebuttal' --body-file <body-file>` |
| <REVIEW_ROUTE_DECISION> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `decision.review-route-decision` | `pixi run isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --placeholder '<REVIEW_ROUTE_DECISION>' --profile decision.review-route-decision --skill isomer-rsch-review-v2 --producer 'isomer-rsch-review-v2' --consumer 'any selected v2 skill' --body-file <body-file>` |
