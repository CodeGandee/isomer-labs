...
| <REVIEW_EXPERIMENT_TODO> | paper/review/experiment_todo.md | Concrete evidence TODOs when review finds real missing evidence. | isomer-rsch-review-v2 | analysis, experiment, decision | research task |
