...
This skill adapts the DeepScientist `paper-outline` research method and outline-pattern reference into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: paper-view and evidence-view split, one-sentence paper idea, fact-versus-interpretation boundary, mature outline checklist, structured outline template, reviewer-facing analysis roles, claim falsification boundaries, negative examples, and outline repair patterns.
