...
If an accepted metric contract needs a concrete schema or file layout, treat it as a metric-contract Artifact and use `[[tbd-surface:path-artifact-layout]]` or `[[tbd-surface:schema-evidence-item]]` for unsettled surfaces.
