# Isomer Research Experiment Production DeepSci Refactor Migration Plan

## Scope

- Source skill: `extern/orphan/DeepScientist/src/skills/experiment`.
- Target skill: `skillset/research-paradigm/deepsci/isomer-rsch-experiment`.
...
experiment maps to isomer-rsch-experiment. Source routes to optimize, analysis-campaign, idea, write, decision, or finalize map to production DeepSci route decisions.
...
- `references/experiment-contract.md`: production DeepSci support page distilled from source entrypoint run-contract and planning rules.
- `references/run-record-template.md`: production DeepSci support page distilled from source entrypoint and execution-playbook recording rules.
