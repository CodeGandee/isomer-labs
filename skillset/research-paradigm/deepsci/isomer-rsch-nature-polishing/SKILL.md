---
name: isomer-rsch-nature-polishing
...
- The task is full paper drafting from evidence; use `isomer-rsch-write`.
- The task is reviewer-response routing; use `isomer-rsch-rebuttal`.
