...
| --- | --- | --- | --- | --- | --- | --- |
| <PAPER_TYPE_DIAGNOSIS> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<PAPER_TYPE_DIAGNOSIS>' --format-profile isomer:deepsci/record-format/profile/decision/paper-type-diagnosis/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'nature-polishing' --payload-file <payload-file> --render markdown --content-name paper-type-diagnosis.md --metadata-json '{"paper_surface":"paper_type_diagnosis"}'` |
| <PROSE_FAILURE_DIAGNOSIS> | report | Prose failure diagnosis Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<PROSE_FAILURE_DIAGNOSIS>' --format-profile isomer:deepsci/record-format/profile/paper/prose-failure-diagnosis/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --render markdown --content-name prose-failure-diagnosis.md --metadata-json '{"paper_surface":"prose_failure_diagnosis"}'` |
| <CLAIM_BOUNDARY_CHECK> | evidence | Claim boundary Evidence Item | `evidence_item` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/claim-boundary-check/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind evidence_item --semantic-label topic.records.artifacts --placeholder '<CLAIM_BOUNDARY_CHECK>' --format-profile isomer:deepsci/record-format/profile/paper/claim-boundary-check/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'nature-polishing, write, review' --payload-file <payload-file> --render markdown --content-name claim-boundary-check.md --metadata-json '{"paper_surface":"claim_boundary_check"}'` |
| <SECTION_LOGIC_REBUILD> | draft | Section logic rebuild Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<SECTION_LOGIC_REBUILD>' --format-profile isomer:deepsci/record-format/profile/paper/section-logic-rebuild/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --render markdown --content-name section-logic-rebuild.md --metadata-json '{"paper_surface":"section_logic_rebuild"}'` |
| <POLISHED_MANUSCRIPT_TEXT> | draft | Polished manuscript text Artifact | `artifact` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind artifact --semantic-label topic.records.artifacts --placeholder '<POLISHED_MANUSCRIPT_TEXT>' --format-profile isomer:deepsci/record-format/profile/paper/draft/polished-manuscript-text/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'write, user' --payload-file <payload-file> --render markdown --content-name polished-manuscript-text.md --metadata-json '{"paper_surface":"polished_manuscript_text"}'` |
| <POLISHING_STYLE_QA> | report | Manuscript language validation View Manifest | `view_manifest` | `topic.records.views` | `isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind view_manifest --semantic-label topic.records.views --placeholder '<POLISHING_STYLE_QA>' --format-profile isomer:deepsci/record-format/profile/paper/validation/manuscript-language/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'nature-polishing, write' --payload-file <payload-file> --render markdown --content-name polishing-style-qa.md --metadata-json '{"paper_surface":"polishing_style_qa"}'` |
| <POLISHING_EVIDENCE_BLOCKER> | decision | Decision Record | `decision_record` | `topic.records.artifacts` | `isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v1` | `isomer-cli --print-json ext research records create --topic <topic> --record-kind decision_record --semantic-label topic.records.artifacts --placeholder '<POLISHING_EVIDENCE_BLOCKER>' --format-profile isomer:deepsci/record-format/profile/decision/polishing-evidence-blocker/v1 --skill isomer-rsch-nature-polishing --producer 'isomer-rsch-nature-polishing' --consumer 'user, write, decision' --payload-file <payload-file> --render markdown --content-name polishing-evidence-blocker.md --metadata-json '{"paper_surface":"polishing_evidence_blocker"}'` |
