...
- The user only wants line editing; use `isomer-rsch-write` or `isomer-rsch-nature-polishing`.
- The task is reviewer-response work after formal reviews; use `isomer-rsch-rebuttal`.
