...
- If the asked-for chart needs many panels, custom layout, image overlays, maps, domain-specific axes, or interactive inspection, create a custom figure-generation Artifact and route final QA to `$isomer-rsch-figure-polish`.
