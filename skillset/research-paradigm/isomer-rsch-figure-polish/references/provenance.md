...
This skill adapts the DeepScientist `figure-polish` companion skill into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: surface classes, one-message figure discipline, chart selection, restrained academic style rules, mandatory render-inspect-revise workflow, self-review checklist, export discipline, durable recording, and practical figure sizing.
