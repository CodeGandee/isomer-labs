...
This skill adapts the DeepScientist `intake-audit` research method and reference material into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: non-blank research-state entry signals, trust-ranked asset inventory, current-board packet construction, paper-facing asset visibility, route handoff logic, and safeguards against cleaned-up histories that hide conflicts.
...
- command, git, and repository inspection became Capability Binding through an Execution Adapter.
