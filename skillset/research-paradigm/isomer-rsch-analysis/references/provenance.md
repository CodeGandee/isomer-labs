...
This skill adapts the DeepScientist `analysis-campaign` research method and reference material into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: campaign route selection, slice-evidence contracts, comparability boundaries, writing-facing evidence, boundary cases, durable record templates, gate checklists, and operational guidance.
