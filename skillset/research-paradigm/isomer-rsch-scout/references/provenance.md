...
This skill adapts the DeepScientist `scout` research method and reference material into a self-contained Isomer Labs skill.

The adaptation preserves reusable methodology: bounded framing, minimum-unknown selection, local-evidence reuse before search, paper and repository triage, evaluation-contract recording, baseline shortlist routing, stop-on-clarity rules, and blocked-state handling.
