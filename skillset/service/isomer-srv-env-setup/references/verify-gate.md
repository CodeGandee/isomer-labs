...
4. **Run verification commands through Pixi** using `pixi run --manifest-path <manifest_path> --environment <pixi_environment> <command>`. Run from the Topic Workspace root unless the derived gate specifies a repo-specific working directory.
