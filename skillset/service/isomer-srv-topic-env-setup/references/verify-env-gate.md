...
2. **Read the target spec**:
   - Extract `## Verification Commands`, `## Expected Results`, `## Blockers`, `## Repo Requirements`, `## Projection Requirements`, any `## Inferred Source Warnings`, and enclosure records for Pixi-managed dependencies, external runtime wiring, and topic-local fallbacks.
3. **Check Pixi files**:
