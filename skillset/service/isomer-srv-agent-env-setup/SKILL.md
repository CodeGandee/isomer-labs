...
- `resource_conservative_decisions`: smoke-test, reduced-scope, reduced-parallelism, selected-agent, skip, defer, or blocker decisions used to avoid multiplying heavy work across every Agent Workspace.
