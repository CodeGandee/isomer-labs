...
1. Require a concrete topic statement or topic id from `define-topic`.
...
5. Report registration status, Project Manifest refs, Topic Workspace path, blockers, and next command.
