...
4. Delegate Topic Actor registration, update, materialization, repair, archive, and diagnostics to `isomer-admin-topic-mgr actors-manage` or the backed `project topic-actors ...` CLI surface.
