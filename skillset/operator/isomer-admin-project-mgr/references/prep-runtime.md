...
3. Run `pixi run isomer-cli --print-json project runtime prepare --topic <topic-id>` to record Topic Environment Readiness.
4. Run `pixi run isomer-cli --print-json project runtime validate --topic <topic-id> --require-ready-readiness` to check launch-facing readiness.
