...
4. If `.isomer-labs/.houmao/` exists or Houmao status matters, run the read-only Houmao Project status command from `references/houmao-bootstrap.md`; do not treat root `.houmao/` as Isomer-managed state.
