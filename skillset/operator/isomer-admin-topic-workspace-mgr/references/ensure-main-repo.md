...
3. If the path is missing and the operator requested creation, create parent `repos/`, initialize `topic-main`, and make the owner-managed branch `topic-owner/main` available without hiding command failures.
