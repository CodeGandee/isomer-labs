...
7. Ensure each prepared worktree has an ignored `.isomer-agent/` support area with `runtime/`, `artifacts/`, `scratch/`, `logs/`, and `links/` subdirectories or report why it could not be prepared.
