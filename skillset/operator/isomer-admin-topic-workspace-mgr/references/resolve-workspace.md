...
Report `research_topic_ref`, `topic_workspace_ref`, `topic_workspace_path`, `topic_main_repo_path`, `agent_workspace_root`, candidate packet/profile files, blockers, and `next_operator_action`.
