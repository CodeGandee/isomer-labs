...
1. Read the latest resolve, repo, Topic Actor, agent plan, worktree, boundary, branch, and validation results available in the operator context.
...
8. Summarize validation status, blockers, skipped actions, generated links, profile or packet edits, and refs that remain to be updated.
9. Name the next operator action:
