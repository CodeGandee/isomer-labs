...
4. Run `resolve-project`, `inspect-template`, and `resolve-context` to gather Project, topic, workspace, template, copied-material, policy, binding, and readiness refs.
