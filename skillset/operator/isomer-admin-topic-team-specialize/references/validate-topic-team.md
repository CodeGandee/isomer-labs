...
2. Read topic definition material, registration assurance evidence, specialization outputs, topic environment setup evidence from `isomer-srv-env-setup`, Agent Workspace paths, delegated Git-backed workspace manager evidence, deferrals, blockers, and validation refs.
