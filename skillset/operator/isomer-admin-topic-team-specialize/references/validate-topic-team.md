...
- `agent_names`, `agent_workspace_paths`, `isomer_managed_path_status`, `branch_plan`, generated-link evidence, or explicit workspace blocker from `setup-agent-workspace`.
