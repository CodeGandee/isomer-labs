...
init-topic
  ...
  -> setup-agent-workspace (routes Git topology, then agent env gate/readiness when requested)
  -> validate-topic-team
  -> finalize-topic-team
